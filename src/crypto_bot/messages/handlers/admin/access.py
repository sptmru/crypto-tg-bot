...
def help_text() -> str:
    return (
        ...
        "Пример использования: /access1234567890.\n"
        "/noaccess - отзыв доступа по <code>user id</code> пользователя. "
        "Данная команда просто временно блокирует доступ к боту, все данные "
        "пользователя сохраняются. Пример использования: "
        "/noaccess1234567890.\n"
        "/deny - отклонение заявки на доступ, используя <code>user_id</code>. "
        "Пример использования: /deny1234567890."
    )
